#
# Be sure to run 'pod lib lint HollowCodable.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'HollowCodable'
  s.version          = '1.0.6'
  s.summary          = 'Codable Customization using PropertyWrappers.'
